...
export const sleepScenarioOptions: readonly SleepScenarioOption[] = [
  {
    ...
    severity: "normal",
    description:
      "Chu kỳ NREM+REM theo chuẩn AASM, hiệu suất ~95%, deep ≥15%, REM ≥20%, awake rất ít. Dùng làm baseline khoẻ mạnh cho mọi user.",
    targets: {
      efficiency: 0.95,
      deepPct: 0.18,
      remPct: 0.22,
  ...
  },
  {
    ...
    severity: "warning",
    description:
      "Nhiều micro-arousal xen kẽ, hiệu suất ~79%, wake_count ≥4 lần. Mô phỏng giấc ngủ rối loạn nhẹ, vẫn còn deep nhưng đứt quãng.",
    targets: {
      efficiency: 0.79,
      deepPct: 0.10,
      remPct: 0.14,
